...
<div class="container mx-auto p-6">
    <div class="flex justify-between items-center mb-4">
        ...
        <div>
            <a href="{{ route('manager.stock.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                + Buat Transaksi Baru
            </a>
            <a href="{{ route('manager.stock.opname.index') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 ml-2">
                Stock Opname
            </a>
        </div>
    </div>
    ...
    <div class="bg-white shadow-lg rounded-lg p-4 overflow-x-auto">
            <form method="GET" action="{{ route('manager.stock.index') }}" class="flex space-x-2">
                <input 
        ...
        <table class="w-full border-collapse border border-gray-200">
            ...
            <tbody>
                ...
                <tr class="text-center border">
                    ...
                    <td class="border p-3">
                        <a href="{{ route('manager.stock.show', $transaction->id) }}" class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">
                            Lihat
                        </a>
                    </td>
                </tr>
