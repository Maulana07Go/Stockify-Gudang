...
<div class="container mx-auto p-6">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-2xl font-bold">Konfirmasi Transaksi Keluar</h2>
    </div>
        ...
        <table class="w-full border-collapse border border-gray-200">
            ...
            <tbody>
                ...
                <tr class="text-center border">
                    ...
                    <td class="border p-3">
                        <a href="{{ route('staff.stock.outconfirm.edit', $transaction->id) }}" class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">
                            Cek
                        </a>
                    </td>
                </tr>
