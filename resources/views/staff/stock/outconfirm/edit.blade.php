...
<div class="max-w-3xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
    ...
    <form action="{{ route('staff.stock.outconfirm.update', $transaction->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-between">
            <a href="{{ session('previous_url', route('staff.stock.outconfirm.index')) }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600">Batal</a>
