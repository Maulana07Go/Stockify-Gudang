...
<div class="container mx-auto p-6">
    ...
    <!-- Form Filter -->
    <form method="GET" action="{{ route('admin.report.index') }}" class="bg-white shadow-lg rounded-lg p-4 mb-4">
    ...
    <div class="bg-white shadow-lg rounded-lg p-4 overflow-x-auto">
        <div class="flex justify-between items-center mb-4">
            ...
            <form method="GET" action="{{ route('admin.report.index') }}" class="flex space-x-2">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-4 md:space-y-0">
            {{-- Form Import CSV --}}
            <form action="{{ route('admin.report.importCsv') }}" method="POST" enctype="multipart/form-data" class="flex items-center space-x-2">
                @csrf
            ...
            {{-- Tombol Export CSV --}}
            <a href="{{ route('admin.report.exportCsv') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg flex items-center space-x-2 hover:bg-green-700 transition">
