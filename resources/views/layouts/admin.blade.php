...
<body class="bg-gray-100 flex flex-col min-h-screen">
    ...
    <header class="fixed top-0 left-0 right-0 bg-gray-800 text-white py-3 px-6 flex justify-between items-center z-50">
        ...
        <div class="relative">
            ...
            <div id="profileDropdownMenu" class="hidden absolute right-0 mt-2 w-48 bg-white text-gray-800 shadow-lg rounded-lg overflow-hidden z-50">
                <a href="{{ route('admin.profile.index') }}" class="block px-4 py-2 hover:bg-gray-100">Profil</a>
    ...
    <div class="flex flex-1 pt-16"> <!-- Menyesuaikan agar tidak tertutup header -->
        ...
        <div id="sidebar" class="fixed left-0 top-16 bottom-9 h-auto w-64 bg-gray-800 text-white flex flex-col p-5 transition-all duration-300">
            <ul class="flex-1">
                <li class="mb-3"><a href="{{ route('admin.dashboard.index') }}" class="block p-2 hover:bg-gray-700"><i class="fas fa-home mr-3"></i>Dashboard</a></li>
                <li class="mb-3"><a href="{{ route('admin.product.index') }}" class="block p-2 hover:bg-gray-700"><i class="fas fa-box mr-3"></i>Produk</a></li>
                <li class="mb-3"><a href="{{ route('admin.stock.index') }}" class="block p-2 hover:bg-gray-700"><i class="fa-solid fa-cubes mr-3"></i>Stok</a></li>
                <li class="mb-3"><a href="{{ route('admin.supplier.index') }}" class="block p-2 hover:bg-gray-700"><i class="fa-solid fa-truck-field mr-3"></i>Pemasok</a></li>
                <li class="mb-3"><a href="{{ route('admin.user.index') }}" class="block p-2 hover:bg-gray-700"><i class="fa-solid fa-users mr-3"></i>Pengguna</a></li>
                <li class="mb-3"><a href="{{ route('admin.report.index') }}" class="block p-2 hover:bg-gray-700"><i class="fa-solid fa-file mr-3"></i>Laporan</a></li>
                <li class="mb-3"><a href="{{ route('admin.setting.index') }}" class="block p-2 hover:bg-gray-700"><i class="fa-solid fa-gear mr-3"></i>Pengaturan</a></li>
            </ul>
        </div>
